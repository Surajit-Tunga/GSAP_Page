        ...
        <div id='video-frame' className='relative z-10 h-dvh w-screen overflow-hidden  bg-blue-75'>
            <div>
                ...
                <video
                 ...
                 loop muted
                 id='next-video'
                 className='absoltue-center invisible absolute z-20 size-64 object-cover object-center'
                 onLoadedData={handleVdLoad}
                />
                <video
            ...
            <h1  className='special-font hero-heading absolute z-40 bottom-5 right-5 text-blue-50'>
                G<b>A</b>MING
            </h1>
